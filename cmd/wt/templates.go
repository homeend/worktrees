...
// printTemplates writes a tab-aligned table of named templates (extracted for
// testing).
...
var templatesCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		_, cfg, _, err := managerForWorkdir()
		if err != nil {
			return err
		}
		return printTemplates(os.Stdout, templateSlice(cfg))
	},
}
